        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination pagination-lg justify-content-center">
            ...
            <li class="page-item">
              ...
              <a class="page-link" href="javascript:void(0);" tabindex="-1" id="pagination"> </a>
            </li>
...
display: none;
  ...
  <!-- MODAL ADD -->
  <form id="addpro" name="addpro" method="POST" action="javascript:void(0);">
    @csrf
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group row">
              ...
              <h6 id="product_pricecheck"></h6>
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            <button type="submit" type="submit" id="save" name="save" class="btn btn-primary">Save Product</button>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group row">
              ...
              <div class="col-md-10">
                <input type="text" name="product_id_edit" id="product_id_edit" class="form-control" readonly>
              </div>
            ...
            <div class="form-group row">
              <label class="col-md-2 col-form-label">Product Code</label>
              <div class="col-md-10">
                <input type="text" name="product_code_edit" id="product_code_edit" class="form-control" placeholder="Product Code">
              </div>
            ...
            <div class="form-group row">
              <label class="col-md-2 col-form-label">Price</label>
              <div class="col-md-10">
                <input type="number" name="product_price_edit" id="product_price_edit" class="form-control" placeholder="Product Price">
              </div>
              <h6 id="product_price_editcheck"></h6>
            </div>
          </div>
          <div class="modal-footer">
